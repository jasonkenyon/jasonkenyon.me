                ...
                <div class="max-w-xl lg:max-w-sm mb-10 text-gray-600">
                    ...
                    <div class="flex justify-between items-center text-sm pt-2">
                        ...
                        @if($project->github != null)
                            <div>
                                <a href="{{ $project->github }}" title="{{ $project->projectName }} Git Repo"
                                   target="_blank" rel="noopener"><i class="fab fa-github text-gray-700"> Source</i></a>
                            </div>
                        @endif
                    </div>
                </div>
    ...
    <div class="min-w-full hero-pattern px-4 py-8">
        <div class="max-w-6xl mx-auto justify-center">
            <div class="flex justify-center">
                <v-lazy-image src="/assets/images/jason.jpeg"
                              class="rounded-full h-32 w-32 shadow-lg border-orange-200 border-2"
                              alt="Picture of Jason Kenyon"/>
            </div>
                ...
                <div class="text-gray-700 leading-relaxed text-gray-700 text-base">
                    ...
                    <p>
                        ...
                        <a href="https://twitter.com/jasonkenyon_" target="_blank" rel="noreferrer"
                           title="Jason Kenyon, on twitter"
                           class="text-orange-600 hover:text-gray-600">@jasonkenyon_</a>
                        and even check out my Github account at
                        <a href="https://github.com/jasonkenyon" target="_blank" rel="noreferrer"
                           title="Jason Kenyon, on github" class="text-orange-600 hover:text-gray-600">@jasonkenyon</a>,
                        any questions feel free to reach out on twitter, give me a
